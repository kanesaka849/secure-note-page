...
###SCHEDULE_SECTION###
  ...
  <div class="card full">
    ...
    <div style="margin-top:10px;padding:10px 12px;border:2px solid #e05555;border-radius:8px;font-size:12px;">
      <strong>🎤 面接当日の流れ（10/19・外部調査で確定）</strong>：個別<strong>30分</strong>・面接官<strong>3名</strong>（AC教員1＝進行＋学類教授2）<br>
      ①雑談（緊張ほぐし）→ ②<strong>「書類提出後に研究が進んでいれば説明して」</strong>→ ③<strong>「自己推薦書を5分で要約して」</strong>→ ④研究の深掘り（学会質疑スタイル）→ ⑤なぜAC入試か・志望理由 → ⑥大学での計画・将来<br>
